...
| --- | --- | --- | --- | --- | --- | --- | --- |
| MiMo-V2-Flash | Atlas 800I A3 | 24 | PD Disaggregation | 16K+1 | 974ms | W8A8 INT8 | [Optimal Configuration](#mimo-v2-flash-16k1-974ms-on-a3-24-cards-disaggregation-mode) |
| MiMo-V2-Flash | Atlas 800I A3 | 24 | PD Disaggregation | 32K+1 | 2,147ms | W8A8 INT8 | [Optimal Configuration](#mimo-v2-flash-32k1-2147ms-on-a3-24-cards-disaggregation-mode) |

### High Throughput

| Model | Hardware | Cards | Deploy Mode | Dataset | TPOT | Quantization | Configuration |
| --- | --- | --- | --- | --- | --- | --- | --- |
| MiMo-V2-Flash | Atlas 800I A3 | 24 | PD Disaggregation | 16K+1K | 16ms | W8A8 INT8 | [Optimal Configuration](#mimo-v2-flash-16k1k-16ms-on-a3-24-cards-disaggregation-mode) |
| MiMo-V2-Flash | Atlas 800I A3 | 24 | PD Disaggregation | 32K+1K | 12ms | W8A8 INT8 | [Optimal Configuration](#mimo-v2-flash-32k1k-12ms-on-a3-24-cards-disaggregation-mode) |
...
Same deployment configuration as [MiMo-V2-Flash 16K+1 974ms](#mimo-v2-flash-16k1-974ms-on-a3-24-cards-disaggregation-mode).
